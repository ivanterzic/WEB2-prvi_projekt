    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                res.render('tournament', { username: ((_a = req.oidc.user) === null || _a === void 0 ? void 0 : _a.name), tournamentName: parsedTournament.competitionName, rounds: parsedTournament.rounds });
                return [3 /*break*/, 4];
            case 3:
                e_1 = _c.sent();
                console.log(e_1);
